...
def onTrackBarChange(x):
    ...
    sc, img = cv2.VideoCapture(0).read()
...
cv2.createTrackbar("HueMax", "TrackBar", 179, 179, onTrackBarChange)
cv2.createTrackbar("SatMin", "TrackBar", 0, 255, onTrackBarChange)
cv2.createTrackbar("SatMax", "TrackBar", 255, 255, onTrackBarChange)
cv2.createTrackbar("ValMin", "TrackBar", 0, 255, onTrackBarChange)
